	        ...
	        <table class="table table-striped" style="width:100%">
	            ...
	            <?php if(count($all_batch_data) > 0){ 
	                ...
	                <?php foreach($all_batch_data as $value){
		            	...
		            	/*
		            	AA) Logic :: alloted -> unallocat => 
		            	A. Status updated by 2 on table 'assist_participant' [i.e onHold] ,
		            	B. value update on table {assist_participant_batch_meta} 'unallocated_batch_initiated';
		            	//------------------------------------------//
		            	BB) Logic :: unallocated -> allot => 
		            	A. Status by 1 on table 'assist_participant' ,
		            	B. increased module allowed by 1, 
		            	C. on table 'assist_participant_batch_meta' value update 'allocated_batch_initiated';
		            	*/
