            ...
            <form method="POST">
                ...
                <div class="form-group col-md-3">
                    <select class="form-control" id="year" name="year" required="">
                        ...
                        <option value="<?= date("Y"); ?>" <?php if (isset($year) && $year == date("Y")) echo "selected"; ?> ><?= date("Y"); ?></option>
                        <option value="<?= date("Y") + 1; ?>" <?php if (isset($year) && $year == date("Y") + 1) echo "selected"; ?> ><?= date("Y") + 1; ?></option>
                    </select>
                </div>
                <div class="form-group col-md-3">
