...
<div class="dv-users-form" id="full_payment_incentive_rate">    
            ...
            <div class="col-sm-12">
                <div class="col-sm-4">
                    <div class="form-group">
                        <input type="number" class="form-control" placeholder="Min Closures" name="DvManageFullPaymentIncentiveRate[min_closures][]" id="min_closures_0" required="required" value="0" readonly=""/>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <input type="number" class="form-control max_closures_val" placeholder="Max Closures" name="DvManageFullPaymentIncentiveRate[max_closures][]" id="max_closures_0" required="required" value="<?= $model->max_closures ?>"/>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <input type="number" class="form-control" placeholder="Rate (%)" name="DvManageFullPaymentIncentiveRate[rate][]" id="rate" required="required" value="<?= $model->rate ?>" max="100" min="0"/>
                    </div>
                </div>
            </div>
            <div class="col-sm-12">
