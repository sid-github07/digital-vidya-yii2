...
<div class="table-responsive"> 
	...
	<input type="hidden" name="all_students_id" id="all_students_id" value="<?php echo isset($all_students_ids) ? $all_students_ids :''; ?>">
	<input type="hidden" name="total_selected" id="total_selected" value="<?php echo isset($_GET['total_selected']) ? $_GET['total_selected'] :''; ?>">
	<input type="hidden" name="batch_allotment_details" id="batch_allotment_details" value="<?php echo isset($_GET['batch_allotment_details']) ? $_GET['batch_allotment_details'] :''; ?>">
</div>
<br>
		...
		<div class="table-responsive">
	        <table class="table table-striped" style="width:100%">
	            ...
	            <?php
	            	...
	            	?>    
	                <?php foreach($batch_data as $value){?> 
		                    <tr>
...
<script>
    ...
    function batch_allocat_students(){
    	...
    	var batch_allotment_details = $('#batch_allotment_details').val();
 		...
 		if(all_students_id!='' && batch_id != '' && batch_id != undefined && total_open_seats >= students_array.length){
	    	...
	    	$.ajax({
	            ...
	            data:{
		            ...
		            batch_allotment_details:batch_allotment_details.toString()
	            },
