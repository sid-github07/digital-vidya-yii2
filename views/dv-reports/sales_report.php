    ...
    <div class="search_form row">
        ...
        <?php if ($current_user_role == 1 || $current_user_role == 6) { ?>
            <div class="col-md-3 form-group">
                ...
                <select class="form-control" required="" name="products" id="products">
        ...
        <?php } ?>
        <div class="col-md-3 form-group">
            <label class="control-label"><small>Showing people in my team</small></label>
            <select class="form-control" required="" name="executives" id="executives">
                <option value="">Select Executive</option>
                <?php
                if (!empty($all_executive_of_manager)) {
                    foreach ($all_executive_of_manager as $executive) {
                        ?>
                        <option value="<?= $executive->id ?>" <?php if ($executives == $executive->id) echo $select ?>>
                            <?php
        ...
        <div class="col-sm-12">
            <table id="sales_report_tbl" class="table" border="1">
                ...
                <tbody>
                    <!-- <tr>
                        <td>Normalized</td>
                        <td id="sold_course_td">0</td>
                        <td id="per_person_average_td">0</td>
                        <td id="your_average_td">0</td>
                    </tr> -->
                    <?php
                    $has_data = 0;
                    $current_period = 0;
                    ...
                    if (!empty($Dv_course)) {
                        foreach ($Dv_course as $course) {
                            ...
                            <tr>
                                ...
                                <td><?= $course['sold_course'] ?></td>
                                <td class="total_current_period">
                                    <?php
                                    $sold_course = $course['sold_course'];
                                    /*if ($course['name'] == "CPDM") {
                                        echo $current_period = $sold_course * 0.8;
                                    } else if ($course['name'] == "CDMM") {
                                        echo $current_period = $sold_course * 1;
                                    } else if ($course['name'] == "DA") {
                                        echo $current_period = $sold_course * 1;
                                    } else {
                                        echo $current_period = $sold_course * 0.33;
                                    }*/
                                ...
                                <td class="per_person_average">
                                    ...
                                    foreach ($all_course_in_this_period as $total_sales) {
                                        if ($total_sales['name'] == $course['name']) {
                                ...
                                <td class="your_average">
                                    ...
                                    if (!empty($all_course_except_this_period)) {
                                        foreach ($all_course_except_this_period as $course_except_this_period) {
                                            if ($course_except_this_period['sales_user_id'] == $executives &&
                                                    $course_except_this_period['name'] == $course['name']) {
                                    ...
                                    /* if (!empty($all_course['user_wise_sold_course'])) {
...
<!--                                <td class="your_average">
                                    <?php
                                    $is_your_avg = 0;
                                    if (!empty($course_sold_last_year_by_current_user)) {
                                        foreach ($course_sold_last_year_by_current_user as $course_sold) {
                                            if ($course_sold['name'] == $course['name']) {
        ...
        <!--                                <td class="company_average">
                            ...
                            <?php
                            $total_sold_course += $course['sold_course'];
                            if($course['mcourse'] == "da"){
                                $total_sales_for_da += $sold_course;
                                $total_sales_for_normlized_da += $current_period;
                            }
                            if($course['mcourse'] == "dm"){
