    ...
    $(document).ready(function(){
        ...
        */
        ...
        $('body').on('change', '#dvregistration-course_format', function (){
            ...
            $.ajax({
                url: '<?php echo \Yii::$app->getUrlManager()->createUrl('dv-cdo-registration/get_coursenamebyid') ?>',
                type: 'POST',
                data: { course_id: course_id, format_id: format_id },
                async:false,
                success: function(data){
           ...
           if((course_name=='DAP')||(course_name=='DSAS')||(course_name=='DAR')||(course_name=='DAE')||(course_name=='DAPS')) {
            ...
            //var workSheetID = "1so_t9u1WkQgWJ23FvQfRWV67Vcc4X1P-vCkfQ7X3xyw"; // Live 
            var workSheetID = "128BmyxJRM3mtgUQMnUzaN65qMNjub8vJsPWPwOHjGdA";  // MY
...
//    });
    ...
    function get_course_data(){
        ...
        if(course_domain!=''){
            $("#loading_custom").show();
            $.ajax({
                url: '<?php echo \Yii::$app->getUrlManager()->createUrl('dv-cdo-registration/course_domain_check') ?>',
                type: 'POST',
